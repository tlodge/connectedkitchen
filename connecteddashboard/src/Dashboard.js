...
function Dashboard() {
    ...
    const renderTime = (root, data=[])=>{
        ...
        timegroupg.append("path").attr("id", "sandtop").attr("class","sand").attr("d","M92.814,111.286C94.995,114.593 96.143,118.343 96.143,122.161C96.143,134.165 85.006,143.911 71.289,143.911C57.571,143.911 46.434,134.165 46.434,122.161C46.434,118.343 47.582,114.593 49.764,111.286C63.482,114.353 77.832,114.353 92.814,111.286Z");

        timegroupg.append("path").attr("id", "sandbottom").attr("class","sand").attr("d","M95.371,204.572C95.371,204.572 99.139,195.725 99.139,190.939C99.139,175.89 86.536,163.671 71.012,163.671C55.488,163.671 42.884,175.89 42.884,190.939C42.884,195.725 46.652,204.572 46.652,204.572L95.371,204.572Z");
    }
